...
function makeThings() {
  ...
  g.append('text').attr('x', 0).attr('y', 20).text('<path')
  ...
  g.append('path').attr('d', file(80, 20)).attr('fill', 'white').attr('stroke', 'black')
  g.append('path').attr('d', file(70, 30)).attr('fill', 'white').attr('stroke', 'black')
  g.append('path').attr('d', file(60, 40)).attr('fill', 'white').attr('stroke', 'black')
  ...
  g.append('path').attr('d', file(270, 20)).attr('fill', 'white').attr('stroke', 'black')
  g.append('path').attr('d', file(260, 30)).attr('fill', 'white').attr('stroke', 'black')
  g.append('path').attr('d', file(250, 40)).attr('fill', 'white').attr('stroke', 'black')
...
function makeLinesUndefined() {
  ...
  d3.select('#undef').append('g').append('path').attr('d', lnMkr(ds)).attr('fill', 'none').attr('stroke', 'red')
}
...
function makeCurveSamples() {
  ...
  svg.append('g').attr('transform', 'translate( 40, 40 )').call(liner, ds, d3.curveLinear, 'd3.curveLinear', txtpos)
  svg.append('g').attr('transform', 'translate( 260, 40 )').call(liner, ds, d3.curveNatural, 'd3.curveNatural', txtpos)
  svg
    .append('g')
    .attr('transform', 'translate( 480, 40 )')
    .call(liner, ds, d3.curveMonotoneX, 'd3.curveMonotoneX', txtpos)

  svg.append('g').attr('transform', 'translate( 40, 250 )').call(liner, ds, d3.curveStep, 'd3.curveStep', txtpos)
  svg
    .append('g')
...
function liner(g, ds, curve, txt, pos) {
  ...
  for (var i = 0; i < curve.length; i++) {
    g.append('path').attr('d', lnMkr.curve(curve[i])(ds)).attr('fill', 'none').attr('stroke', sc(i))
  }
...
function makeTransformation() {
  ...
  d3.select('#sticker').append('g').call(trsf1, 200, 150).call(sticker, 'Boo!').select('.frame').attr('stroke', 'green')
